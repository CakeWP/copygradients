      ...
      <Fragment>
        ...
        >
          <div className="max-w-screen-xl w-full mx-auto">
            ...
            <p className="text-white text-xl py-5">
              To easily copy and paste gradients on WordPress just install the&nbsp;
              <a href="https://editorskit.com" className="underline">
                EditorsKit Plugin↗
              </a> which is available for free. With EditorsKit, you can enable the copy & paste controls on the block that supports gradient like button and cover blocks.
            </p>
